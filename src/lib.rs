...
day_bridge::bridge! {
    ...
    c!(r#"
        ...
        extern SPDConnection* spd_open(const char*, const char*, const char*, SPDConnectionMode);
    ...
    cpp!(r#"
        ...
        /* One voice for the process, created on first use. COM may already be initialized on this
           thread by the host app — S_FALSE and RPC_E_CHANGED_MODE both mean "already up", and
           SAPI is happy in either apartment. */
